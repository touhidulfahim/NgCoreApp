...
public class AntiXssMiddleware
{
    ...
    private static readonly List<string> AllowedContentTypeForBinaryData = new List<string>
    {
        //PELSOR3Constant.UploadContentType.ExcelContentType,
        //PELSOR3Constant.UploadContentType.ExcelxContentType,
        //PELSOR3Constant.UploadContentType.ExcelMacroEnabled
    };
    ...
    {
        #region "Check and ignore if excel upload"
        if (context.Request.ContentType != null && context.Request.ContentType.Contains("multipart/form-data"))
        {
            ...
            {
                if (formData.Files.Select(x => x.ContentType).Intersect(AllowedContentTypeForBinaryData).Any())
                {
                    return string.Empty;
                }
            }
